...
//		acc2.group = new Group[] {grp6,grp7};
		...
		String[] Name = {"tung","thao","tuan","phuong","duy","tan"};
		Random random3 = new Random();
		int res = random3.nextInt(Name.length);
		System.out.println("Random String is: " + Name[res] );
		...
		System.out.println("-- câu 3: Viết lệnh cho phép người dùng nhập họ và tên");
		...
		nam.Ten = sc3.next();
		System.out.println("Người dùng vừa mới nhập là: " + nam.Ho +" "+ nam.Ten);
